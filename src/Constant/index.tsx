...
export const StarColorTwo = "#FF8F0F ";
//  Authentication
...
export const OrderTotal: string = "SubTotal";
...
export const SearchCairo: string = "Search...";
export const Pinned: string = "Pinned";
export const Search: string = 'Search Cairo...'

//  DashBoard 
export const Welcome: string = 'Welcome to cairo';
export const happeningStore: string = 'Here’s what’s happening with your store today.';
export const UpgradePlan: string = 'Upgrade Plan';
export const Supervisor: string = 'Supervisor';
export const SophiaTaylor: string = 'Sophia Taylor';
export const New: string = 'New';
export const SeeMoreAdministor : string = 'See more administrative details';
export const Configuration: string = 'Browser Configuration';
export const Interactionborswer: string = 'Active user interaction in browser'
export const Summary : string = 'Shifts Summary'
export const Monthlysales: string = 'Monthly Sales'
export const TotalSell: string = "Total Sells";
export const OrdersValue: string = 'Total Product';
export const OnlineOrder: string = 'Online Orders'
export const Orderstatus: string = 'Order Status'
export const HeadPhone: string = 'Wireless Headphones (Trending)'
export const HeadPhonePrice: string = '$30.75'
export const Categorysummary: string = 'Category Summary'
export const Currentcustomers: string = 'Current Customers'
export const Trendingproducts: string = 'Trending Products'
export const ButtonNew: string = 'New'
export const Completelyatease: string = 'Completely at ease'
export const NewSportsShoes: string = 'New Sports Shoes'
export const BuyNowButton: string = 'Buy Now'

export const Latestsales : string = 'Latest Sales'
export const Productsoverview: string = 'Products Overview'
export const productHeadingNum: string = '4035 Views'
export const ProductHeadingTitle: string = '( Interactions of sale items )'
export const RecentOrder: string = "Recent Orders";
//  Recent Transaction
export const Recenttransaction : string = 'Recent Transaction'

// Important Task List
export const ImportantTask: string = 'Important Task List'

//  Trending Orders
export const Trendingorder: string = 'Trending Orders'

// Sales Analytics
export const Salesanalytic: string = 'Sales Analytics'

//  ======= widgets component ======== 

export const Visitor: string = 'Visitors'
export const Transactionhistory: string = 'Transaction History'
export const ShiftSummarys: string = 'Shifts Summary'
export const Projectcreated: string = 'Project Created'
export const Salesoverview: string = 'Sales Overview'
export const Monthlyhistory: string = 'Monthly  History'
...
export const FinanceTitle: string = 'Finance'
export const UserTitle: string = 'Uses'

//  Page Layout Component ================ 

export const Boxlayout: string = 'Box Layout'
export const TipTitle: string = 'Tip!'
export const Boxparagraph : string = 
' Add class="box-layout" attribute to get this layout. The boxed layout is helpful when working on large screens because it prevents the site from stretching very wide.'
...
export const SearchFile: string = 'Search...'

//  kanban Borad =========== 
export const DefaultDemos: string = 'Default Demo'
...
export const ProductDetails: string = "Product Detail";
...
export const ProductTittle: string = "Women white shirt";
...
export const CairoEmail: string = "Cairo@gmail.com";
export const EnterYourFirstName: string = "Enter first name";
export const EnterYourLastName: string = "Enter last name";
...
//  add Product 
export const AddProductTitle ="Product Title"
...
//  Ecommerce - Pricing
export const Becomemember: string = 'Become member'
...
export const MoreComment: string = 'More Comments'
export const CommentPostPlaceholder: string = 'Post Your comments'
export const ProfileIntroTxt: string = 'Profile Intro'
export const Facebook: string = 'Facebook'
export const Twitter: string = 'Twitter'
export const Dribbble: string = 'Dribbble'
export const Followerstxt: string = 'Followers'
export const AddFriend: string = 'Add Friend'
export const Followingstxt: string = 'Followings'
export const LatestPhototxt: string = 'Latest Photos'
export const Friendstxt: string = 'Friends'
...
export const CanHelpYou : string = 'How Can I help you?'
...
export const NewTasktxt: string = "New Task";
...
export const Documentation: string = "Created By Me";
export const TodayTasks: string = "Today's Tasks";
export const DelaydedTaks : string = 'Delayed Tasks'
...
export const LookGood: string = "Looks good!";
...
export const FirstNamee: string = "First name";
export const LastNamee: string = "Last name";
...
export const Indeterminates: string = "Indeterminate";
...
export const DangerCheckboxSolid : string = 'Danger - checkbox-solid-danger'
export const InfoChekcboxSolid : string = 'Info - checkbox-solid-info'
...
export const ImagesWitRadios: string = "Images with radio";
...
export const WrappingParagraph: string = "Input groups wrap by default via flex-wrap: wrap in order to accommodate custom form field validation within an input group. You may disable this with ";
...
export const VariationOfaddon: string = ' Place one add-on or button on either side of an input. You may also place one on both sides of an input. Remember to place '
export const VariationOfAddonCode: string = 'label'
export const VariationOfAddonCode1: string = 's outside the input group.'
...
export const UpgradeParagraph:string = "Select the theme that best suits your requirements, and you're ready to go!";
...
export const Weeks: string = "Week";
...
export const CustomizingConjunctionHeading: string = "Customizing Conjunction";
...
// Select 2
export const DefaultSelectTitle : string = 'Single-value select'
...
export const PlaceHolderNamee: string = "Placeholder Name";
...
export const LinkedInPlaceholder: string = "https://linkedIn.com/cairo";
export const GitHubPlaceholder: string = "https://github.com/cairo";
export const TwitterPlaceholder: string = "https://twitter.com/cairo";
...
export const EnterYourAddress: string = 'Enter your address...'
export const AddressType:string = 'Address Type'
export const ContactNo: string = 'Contact No'
...
export const AadhaarNumberr: string = "Aadhaar Number";
export const PanPlaceholder: string = "xxxxxxxxxx";
export const emailtxt: string = 'Cairo@example.com'
...
export const BasicTableWithBorderheading: string = 'Basic Table With Border Bottom Color'
export const InverseTableWithPrimaryy: string = 'Inverse Table with Primary background'
export const ResponsiveTablesWithLBgg: string = 'Responsive Tables With Light Background'
export const Sizingtabless: string = 'Sizing Tables'
export const CustomTableColorHoverStrippedd: string = 'Custom Table Color With Hover And Stripped'
export const DashedBorderr: string = 'Dashed Border'

//  Table COmponent Bootstap 
export const UIComponentss: string = 'UI Components'
export const Alerts: string = 'Alerts'
export const Progressbarr: string = 'Progressbar'
export const Checkboxx: string = 'Checkbox'
export const RadioButtonss: string = 'RadioButtons'
export const SelectTitle: string = 'Select'
export const InputTitle: string = 'Input'
export const Badgess: string = 'Badges'
export const TooltipTrigger: string = 'Tooltip Triggers'
export const Switchs: string = 'Switch'
...
export const FontWeightt: string = "Font Weight";
...
export const InlineTextElementss: string = "Inline text elements";
...
export const Ratio: string = "Ratios";
export const Grouping: string = "Grouping";
export const BadgeIndicatortxt:string = 'Badge-Indicator'
export const Initialletteravatar: string = 'Initial Letter Avatar'
export const Animatedavatar: string = 'Animated Avatar'


// Ui Kits- DIvider
export const Horizontalsoliddivider: string = 'Horizontal Solid Divider'
export const Horizontaldasheddivider: string = 'Horizontal Dashed Divider'
export const Horizontaldotteddivider: string = 'Horizontal Dotted Divider'
export const VerticalDashedDividerr: string = 'Vertical Dashed Divider'
export const VerticalDottedDividerr: string = 'Vertical Dotted Divider'
export const VerticalDoubleDividerr: string = 'Vertical Double Divider'
export const AnimatedColorDividerr: string = 'Animated Color Divider'
export const MainHeadingTxt: string = 'Main Heading'
export const HorizontalEditableDividerr: string = 'Horizontal Editable Divider'
export const SimpleHorizontalDividerr: string = 'Simple Horizontal Divider'
export const SimpleVerticalDividerr: string = 'Simple Vertical Divider'

//  UI Kits- Helper Classes 
export const Styledborder: string = 'Styled Borders'
export const BorderRadiusheading: string = 'Custom Border-radius Class'
export const BorderColors: string = 'Border Color'
export const borderWidth: string = 'Border Width'
export const TextColorstxt: string = 'Text Colors'
export const VariationBordersDisplay: string = 'Variation of Borders and Displays'
export const AdditiveBorders: string = 'Additive Border'
export const SubtractiveBorders: string = 'Subtractive Border'
export const AddtiveRadiuss: string = 'Additive Radius'
export const backgroundcolor: string = 'Background Colors'
export const DarkBackgrounds: string = 'Dark Background'
export const lightBackground: string = 'Light Backgrounds'
export const ExtendedBackgrounds: string = 'Extended Background Colors'
export const BorderdColor: string = 'Border Color'
export const ImageSize: string = 'Images Sizes'
export const FontStyles:string = 'Font-style'
export const FontWeights: string = 'Font Weight'
export const textColor: string = 'Text Colors'
export const PaddingHeading: string = 'Padding'
export const Dashedborder: string = 'Dashed Border'
export const Dottedborder: string = 'Dotted Border'
export const Grooveborder: string = 'Groove Border'
export const Ridgeborder: string = 'Ridge Border'
export const onlyOneSidePadding:string = 'Only One Side Padding'
export const paddingLeft:string = 'Padding Left'
export const PaddingRights: string = 'Padding Right'
export const Paddingtop: string = 'Padding Top'
export const PaddingBottoms: string = 'Padding Bottom'
export const Margin: string = 'Margins'
export const JustOneSideMargin: string = 'Just One Side Margin'
...
export const margintop: string = 'Margin Top'
export const FontSizee: string = 'Font Sizes'

//  Ui Kits - Grid 
export const Gridoptions: string = 'Grid Options'
export const Gridbehavior: string = 'Grid behavior'
export const Horizontalatalltimes: string = 'Horizontal at all times'
export const StartHorizontalBreakpoint: string = 'Collapsed to start, horizontal above breakpoints'
export const Maxcontainerwidth: string = 'Max container width'
export const Classprefix: string = 'Class prefix'
export const GridColum: string = 'Grid for Columns'
export const EnablBehaviors: string = 'Enable Flex Behaviors'
export const Horizontalgutters: string = 'Horizontal Gutters'
export const CustomcolumnPadding: string = 'Custom column padding'
export const Vertical_Gutters: string = 'Vertical Gutters'
export const Row_ColumnsGutters: string = 'Row Columns Gutters'
export const No_Gutters : string= 'No Gutters'
export const verticalAlignment: string = 'Vertical Alignment'
export const verticalfooter: string = ' start / center / end / baseline / stretch'
export const AlignItemCode: string ='.align-items-*'
export const AlignClass : string = ' Class'
export const verticalValueofclass : string = 'Value of the class'
export const HorizontalAlignmentHeading: string = 'Horizontal Alignment'
export const ValueClass: string = 'start / center / end / around / between'
export const horizontalCode: string = '.justify-content-*'
export const NestingHeading: string = 'Nesting'
export const OrderHeading: string = 'Order'
export const OrderCodetitle: string = '.order-*'
export const OrderValueData: string= ' first / 2 / 3 / 4 / 5 / last'
export const OffsetHeading: string = 'Offset'
export const OffsetClassData: string = '.offset-*-*'
export const OffsetValueData : string = ' 1 / 2 / ... / 10 / 11'

//  Ui Kits - Tag & Pill
export const BadgesContextualVariationsCart: string = "Badges Contextual Variations";
export const BadgesOutlineContextualVariationCart: string = 'Badges Outline Contextual Variations'
export const PillContextualVariationsCart: string  ='Pill Contextual Variations'
export const PillOutlineVariationsCart: string = 'Pill Outline Variations'
export const NunberOfBadgeCart: string = 'Number of Badges'
export const NumberOfPillBadgesCart: string = 'Number of Pill Badges'
export const BadgeTagWithIconsCart: string = 'Badge Tag with Icons'
export const RoundedPillsWithIconsCart: string = 'Rounded Pills with Icons'
export const BadgeHeadingsCart: string = 'Badge Headings'
export const PositionedBadgesCart: string = 'Positioned Badges'
export const ButtonBadgesCart: string=  'Button Badges'
export const ImageBadgesCart: string = 'Image Badges'
export const CloseBadgesCart: string = 'Close Badges'
export const ImageWithCloseBadgesCart: string = 'Image With Close Badges'

//  Ui Kits - progress
export const InitialProgressBar: string = 'Initial Progress Bars'
export const StripedProgressBar: string = 'Striped Progress Bars'
export const AnimatedProgressBar: string = 'Animated Progress Bars'
export const MultipleBar: string = 'Multiple Bars'
export const ProgressWithNumberStep: string = 'Progress With Number Steps'
export const CustomProgressBar : string = 'Custom Progress Bars'
export const SmallProgressBar: string = 'Small Progress Bars'
export const LargeProgressBar: string = 'Large Progress Bars'
export const CustomHeightProgressBar: string = "Custom Height Progress Bars";
export const StepProgressbars: string = 'Step Progress bar'
...
export const OpenModalForCairo: string = "Open Modal for Cairo";
export const SaveChanges: string = "Save changes";
export const SignUp: string = " SIGN-UP";
export const AcceptPolicy: string = 'You accept our Terms and Privacy Policy by clicking Submit below.'
export const SizesModal: string = "Sizes Modal";
export const FullScreenModals: string = "Fullscreen modal";
...
export const FullScreenModal: string = "Fullscreen modals";
...
export const ToggleBetweenModal: string = "Toggle Between Modal ";
...
export const CairoLogin: string = "Cairo Login";
export const Gridmodal: string = 'Grid Modal'
export const ScrollingLongContent: string = 'Scrolling Long Content Modal'
export const ScrollingModal: string = 'Scrolling Modal'
export const ScrollingLongModalBtn: string = 'Scrolling Long Modal'
export const CairoCustomModal: string = "Cairo Custom Modals ";
export const ClickHere: string = 'Click Here'

//  Ui Kits - alerts
export const DarkThemeTitle: string = 'Link Color In Dark Theme'
export const LightThemeTitle: string= 'Link Color In Light Theme'
export const OutlineAlets: string = 'Outline Dark and Light Alerts'
export const IconandtextAction: string = 'Alerts with Icons and Text Actions'
export const LiveAlerts: string = "Live Alert";
export const ShowLiveAlert: string = "Show live alert";
export const DismingLightAlerts: string = 'Dismissing Light Alert'
export const DismingDarkAlerts: string = 'Dismissing Dark Alert'
export const LeftborderAlerts: string = 'Left Border Alert'
export const CustomAlertPopups: string = 'Custom Alert Popup'
export const Later: string = 'Later'
export const RightNow: string = 'Right Now'
export const iconWithAlert: string = 'Icons with Alerts'
export const AdditionalContent: string = 'Additional Contents'

//  Ui Kits - Popover
export const Basicpopover: string = 'Basic Popover'
export const HurryUps: string = "Hurry Up!";
export const DisabledElement: string = 'Disabled Elements'
...
//  Ui Kits - Placeholder
export const PlaceholderCard: string = 'Placeholder Cards'
export const WidthandSizing: string = 'Width & Sizing'
export const WidthTxt:string = 'Width'
export const SizingTxt: string = 'Sizing'
export const Animations: string = 'Animation'
export const CustomAnimationplaceholder : string = 'Custom Animation Placeholder'
export const Color : string = 'Colors'
...
export const LightTooltip: string = 'Light Tooltips'
...
export const AlignmentOption: string = 'Alignment Options'
...
//  Ui Kits - Navigate Link
export const Linkutilities: string = 'Link Utilities'
export const Linkunderlines: string = 'Link Underlines'
export const BorderOpactity: string = 'Border Opacity'
export const BackgroundColorOpacitys: string = 'Background Color Opacity'
export const CommonLink: string = 'CommonLinks'
export const Linkopacity: string = 'Link Opacity'
export const HoverLinkopacity: string = 'Hovered Link Opacity'
export const UnderlineOpacitys: string = 'Underline Opacity'
export const Underlineopacity: string = 'Underline Offset'

// Ui Kits Offcanvs
export const OffcanvasDirection: string = 'Offcanvas Directions'
export const  Topoffcanvas: string = 'Top Offcanvas'
...
export const PageTab: string = "Pages";
export const AboutUs: string = "About us";
export const Blog: string = "Blog";
export const CairoProfilesForNewEmployees: string = "Cairo Profiles For New Employees:";
...
export const BackgroundPillTab: string = 'Background Pill Tab'
export const sofa: string = 'Sofa'
export const Chair: string = 'Chairs'
export const Table: string = 'Tables'
export const Arrowtab: string = 'Arrow Tabs'
export const AccountInfos: string = 'Account Info'
export const Portfolios: string = 'Portfolio'
export const Skill : string = 'Skills'
export const Installments: string = 'Installment'
export const Botttomtab: string = 'Bottom Tabs'
export const Css: string = 'CSS'
export const Vendor: string = 'Vendors'
export const JavaScripts: string = 'Javascript'
export const AnimatedHorizontalTab: string = 'Animated Horizontal Tabs'
...
// Bonus Ui - Toast
export const MessageToast: string = 'Message Toasts'
...
//  Bonus Ui - Rating
export const StarRatingsTitle: string = 'Star Rating'
export const StrokeStarRatings: string = 'Stroke Star Rating'
export const StarMessageRatings: string = 'Star with Message Rating'
export const ResetRatings: string = 'Reset Rating'
export const SliderEmojiRatings: string =' Slider Emoji Rating'
export const RangeRatings: string = 'Range Rating'
export const HalfStarRatings: string = 'Half Star Rating'
export const AnimatedRatings: string = 'Animated Rating'
export const AnimatedHeartRatings: string = 'Animated Heart Rating'
...
export const MultiFileUploads: string = "Multiple File Upload";
...
// Bonus Ui - SweetAlet-2
export const PositionTopStarts: string = 'Position Top Start'
export const ClickIt: string = 'Click it!'
export const PositionTopEnds: string = 'Position Top End'
export const PositionBottomStarts: string = 'Position Bottom Start'
export const PositionBottomEnds: string = 'Position Bottom End'
export const BasicExamples: string = "Basic Example";
export const TitleWithTextUnders: string = 'Title with a Text Under'
export const DismissAlerts: string = 'Dismiss Alert'
export const RichHtmlAlerts: string = 'Rich Html Alert'
export const ConfirmationAlerts: string = 'Confirmation Alert'
export const AnimatedAlerts: string = 'Animated Alert'
export const ConfirmationWithTrigger: string = 'Confirmation With Triggers'
export const ImageRichMessages: string = 'Image-Rich Message'
export const AutoCloseTimers: string = 'Auto Close Timer'
export const AJAXRequestAlerts: string = 'AJAX Request Alert'
export const ConfirmationWithApproval: string = 'Confirmation With Approvals'
export const ComprehensiveRTLSupports: string = 'Comprehensive RTL Support'
export const PasswordGeneratorAlerts: string = 'Password Generator bAlert'
export const DateAlerts: string = 'Date Alert'
export const CustomPositionedDialogs: string = 'Custom Positioned Dialog'
export const RegistrationForms: string = 'Registration Form'
...
export const AnimatedRibbon: string = 'Animated Ribbons' 
...
export const CairoTheme: string = "Cairo Theme";
...
//  Bonus Ui - CreativeCards
export const AddTitleOfCards: string = 'Add the title of the card'
export const BorderLefts: string = 'Border Left'
export const BorderRights: string = 'Border Right'
export const Emailaddress: string = "Email address";
export const BorderTops: string = 'Border Top'
export const BorderBottoms: string = 'Border Bottom'
export const BorderPrimaryStates: string = 'Border Primary State'
export const BorderWarningStates: string = 'Border Warning State'
export const BorderSecondaryStates: string = 'Border Secondary State'
...
export const AnimatedTimelines: string = 'Animated Timeline'
export const HalfRoundedTimelines: string = 'Half Rounded Timeline'
...
export const FlatButtonHeading: string = 'Flat Button'
export const RaisedWithEdgeButtonsHeading : string = 'Raised With Edge Buttons'
...
export const BubbleChart3Ds: string = ' 3d Bubble Chart '
export const SteplineCharts: string = 'Stepline Chart'
export const PieCharts: string = 'Pie Chart'
export const DonutCharts: string = 'Donut Chart'
...
export const RadialBarCharts: string = 'RadialBarChart'

//  Charts- Google Chart
export const AreaCharts: string = 'Area Chart 1'
...
//  Pages - sample Page
export const SampleCards: string = 'Sample Card'

//  Error 400 
export const BackToHomePage: string = "BACK TO HOME PAGE";
export const ErrorContent: string = "The page you are attempting to reach is currently not available. This may be because the page does not exist or has been moved.";
...
export const RadarGraphs: string = 'Radar Graph'
export const DoughnutCharts: string = 'Doughnut Chart'
...
export const descriptionGallery :string = "is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy." 


//  Miscellaneous - BLog
export const LatestNewsAndTrend: string = 'Latest News and Trends'
export const TrendingPost: string = 'Trending Posts'
export const FollowUs: string = 'Follow Us'
export const RecentPost: string = 'Recent Posts'
export const PopularTag: string = 'Popular Tags'
export const Subscribers: string = 'Subscriber'
export const TechnologyAndBusiness: string = 'Exploring the Intersection of Technology and Business'
export const Comments: string = 'Comments'
export const LeaveYourComments: string = 'Leave Your Comment'
export const EnterYourEmail: string = 'Enter your email'
export const Website: string = 'Website'
export const EnterYourWebsite: string = 'Enter your website'
export const WriteAComment: string = 'Write your comment'
...
export const SearchArticle: string = "Search Articles";
...
export const JobHeading: string = "Job Title";
...
export const CairoMatchettVandelayLTD: string = 'Cairo Matchett Vandelay Group LTD'
...
export const InvoiceTaxs: string = 'Tax(5%)'
...
export const Cairo: string = "Cairo";
export const Invoice: string = "Invoice";
...
export const UpcomingCourse: string = 'Upcoming Courses'
...
export const LeafletWorldMaps: string = "Leaflet World MAP";
...
export const  Togglebothelement: string = ' Toggle both element'
...
//  Image cropper
export const ImageCroppers: string = 'Image Cropper'
...
//  ReactStrap Carousel 
export const SlidesOnlys: string = 'Slides Only'
...
export const IndividualIntervals: string = 'Individual Carousel-Item Interval'
