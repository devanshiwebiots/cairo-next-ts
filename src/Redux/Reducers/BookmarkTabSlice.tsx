...
const BookmarkTabSlice = createSlice({
  ...
  initialState,
  reducers: {
    toggleBookmarkModal(state, action) {
...
export const { updateBookMark,setRemoveBookmark, setBookMarkList, setBookmark, setEditRow, setEditModal, setGridView, setTagModal, updateActiveTabs, setBookmarkValidation, addNewBookmark, setAddModal, setBookmarkFilter,toggleBookmarkModal, toggleTagModal } = BookmarkTabSlice.actions;
