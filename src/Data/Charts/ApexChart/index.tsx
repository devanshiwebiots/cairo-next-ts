...
const primary = "#015DBE";
const secondary = "#FFB70D";
...
export const BasicApexChart: ApexOptions = {
  chart: {
    height: 350,
    type: "area",
    zoom: {
...
export const AreaSpalineChartsData: ApexOptions = {
  chart: {
    height: 350,
    type: "area",
    toolbar: {
...
export const BarChartsData: ApexOptions = {
  chart: {
    height: 350,
    type: "bar",
    toolbar: {
...
export const BubbleChart3DData:ApexOptions = {
    chart: {
      height: 350,
      type: "bubble",
      toolbar: {
...
export const ColumnChartTwoData: ApexOptions = {
   annotations: {
     yaxis: [
       {
         y: 8200,
...
export const DountChartsData: ApexOptions = {
  chart: {
    width: 380,
    type: "donut",
  },
  ...
  colors: ["#dc3545", "#f8d62b", primary, "#61AE41", "#26a7d6"],
};


export const MixedChartsData: ApexOptions = {
   chart: {
     height: 350,
     type: "line",
     stacked: false,
   ...
   colors: [secondary, "#61AE41", primary],
 };

export const CandlestickChartsData: ApexOptions = {
   chart: {
     height: 350,
     type: "candlestick",
     toolbar: {
