  ...
  datasets: [
    {
      ...
      backgroundColor: "rgba(1, 93, 190, 0.4)",
      borderColor: primary,
      hoverBackgroundColor: "rgba(1, 93, 190, 0.6)",
      hoverBorderColor: primary,
      data: [35, 59, 80, 81, 56, 55, 40],
    },
    {
      label: "My Second dataset",
      backgroundColor: "rgba(255, 183, 13, 0.4)",
      borderColor: secondary,
      hoverBackgroundColor: "rgba(255, 183, 13, 0.6)",
  ...
  datasets: [
    {
      ...
      data: [28, 48, 40, 19, 86, 27, 90],
      borderColor: secondary,
      backgroundColor: "rgba(1, 93, 190, 0.3)",
      borderWidth: 2,
    },
    {
      fill: true,
      ...
      label: "My Second dataset",
      borderColor: primary,
      backgroundColor: "rgba(255, 183, 13, 0.3)",
      borderWidth: 2,
    },
  ],
  plugins: {
...
export const LineChartData = {
  ...
  datasets: [
    ...
    {
      fill: true,
      backgroundColor: "rgba(255, 183, 13, 0.2)",
    ...
    {
      fill: true,
      backgroundColor: "rgba(1, 93, 190, 0.2)",
      borderColor: primary,
      pointColor: primary,
