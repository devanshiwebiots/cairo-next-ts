...
export const BasicTableBorderColor = [
  ...
  export const InverseTablesData = [
    {
        text: 'Use a class',
        code: 'table-inverse'
    },
...
export const StripedRowData = [
  ...
  },
  {
    ...
    code: ". This styling doesn't work in IE8 and below as :nth-child CSS selector isn't supported."
  }
]

export const BreakPointSpecificData = [
  {
    text: 'Use ',
    code: '.table-responsive.custom-scrollbar"❴-sm|-md|-lg|-xl|-xxl❵"'
  },
  {
    text: 'functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.'
  }
...
export const BreakPointSpecificList = [
  {
    id: 1,
    head: 'Id'
  },
...
export const BreakPointSpecificBody = [
  {
    id: 1,
    name: 'Iphone X Grey',
    orderId: 'C12345',
...
export const ResponsiveLightBackgroundData = [
  {
    text: 'A',
    code: '.table-responsive.custom-scrollbar ,.light-card'
  },
  {
    text: 'inside table element.'
  }
...
export const ResponsiveLightBackgroundList = [
  {
    id: 1,
    head: 'Id',
  },
...
export const CustomColorHoverStrippedData = [
  {
    text: 'Use class ',
...
export const CustomColorHoverStrippedList = [
  {id: 1, head: 'Id'},
