...
export const TabsData = [
  ...
  export const IconTabData = [
    ...
    {
      text: " class to switch particular tabs and with",
      code: '"Ico"',
    },
    {  
        text: ' icons you can take',
        code: '"tab".'
    },
  ];
...
export const VerticalTabData = [
    ...
    {
      text: "id to change vertical tabs.",
    },
  ];
  ...
  export const MaterialStyleData = [
    ...
    {
      text: "class to switch and customize tabs.",
    },
  ];
  ...
  export const MaterialStyleDataList = [
    ...
    },
    {
      ...
      tableData: [
        { id: 1, name: "Neha", country: "India", rating:<Fragment><Star/><Star/><Star/><Star/></Fragment>},
        { id: 3, name: "Irfan", country: "India", rating: <Fragment><Star/><Star/><Star/></Fragment>}
      ],
    },
  ];
  ...
  export const BorderTabData = [
    ...
    {
      text: " class to add bottom border styles.",
    },
  ];

  export const BackgroundPillTabsaData = [
    {
      text: 'Use of the',
      code: 'active'
    },
  ...
  export const BottomTabsData = [
    ...
    {
      text: 'It is possible to build a arrow tab with the',
      code: 'new-item '
    },
    {
      text :'class.'
  ...
  export const AnimatedHorizontalTabsData  =[
    {
      text: 'Use of the',
      code: 'active'
    },
    ...
    {
      text: '. It is possible to build a animated tab with the',
