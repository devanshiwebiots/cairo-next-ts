...
export const BasicData = [
  ...
  export const GridModalSpan = [
    {
      text: 'Utilize the Bootstrap grid system within a modal by nesting ',
    ...
    {
      text: '. Then, use the normal grid system classes as you would anywhere else.'
    }
  ]

  export const ScrollingLongContentModalSpan = [
    {
      text: ' You can also create a scrollable modal that allows scrolling the modal body by adding ',
  ...
  export const ScrollingLongWebDesingerData = [
    {
      text: "As a web designer, you either prefer to work freelance for several different businesses at once or you may choose to work for just one. In either case, you'll need good time management skills to keep several projects moving forward."
    },
    {
  ...
  export const ScrollingLongUXDesigner = [
    {
