export const BasicPopoverSpan = [
    {
        text: 'use the common class',
        code: "data-bs-toggle='popover'"
    },
    {
        text: 'and hover to use the ',
        code: "attributes.data-bs-trigger='hover'"
    },
    {
        text: 'attributes.'
    }
  ...
  export const OffsetList = [
    {
      ...
      Popoverbody: "And here's some amazing content. It's very engaging. Right?",
      btnColor: "secondary",
