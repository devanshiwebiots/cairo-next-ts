...
export const MenuList: MenuItem[] | undefined = [
  ...
  },
  {
    ...
    Items: [
      ...
      { path: "/app/file_manager", icon: "file", title: "File Manager", type: "link" },
      {
        ...
        children: [
          ...
          { path: "/ecommerce/recent_order", title: "Order History", type: "link" },
          {
            ...
            type: "sub",
            children: [
              { path: "/invoice/invoice_1", title: "Invoice-1", type: "link" },
              { path: "/invoice/invoice_2", title: "Invoice-2", type: "link" },
              { path: "/invoice/invoice_3", title: "Invoice-3", type: "link" },
              { path: "/invoice/invoice_4", title: "Invoice-4", type: "link" },
              { path: "/invoice/invoice_5", title: "Invoice-5", type: "link" },
      ...
      { path: "/app/letter_box", icon: "email", title: "Letter Box", type: "link", id: 6 },
      {
        title: "Chat",
        id: 7,
        icon: "chat",
            ...
            children: [
              {
                title: "Basic Tables",
                type: "link",
                path: "/table/reactstrap_table/basic_tables",
              },
              {
    ...
    Items: [
      {
        ...
        children: [
          ...
          { path: "/ui_kits/divider", title: "Divider", type: "link" },
          ...
          { path: "/ui_kits/placeholders", title: "Placeholders", type: "link" },
          ...
          { path: "/ui_kits/navigate_links", title: "Navigate Links", type: "link" },
...

  {
    ...
    Items: [
...

      {
        ...
        active: false,
        children: [
          { path: "/blog/blog_grid", title: "Blog Grid", type: "link" },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "/map/leaflet_map", type: "link", title: "Leaflet Maps" },
        ],
      },
      {
        title: "Editors",
      ...
      { id: 36, path: "/miscellaneous/knowledgebase", icon: "knowledgebase", type: "link", active: false, title: "Knowledgebase" },
      { id: 37, path: "/miscellaneous/support_ticket", icon: "support-tickets", type: "link", active: false, title: "SupportTicket" },
    ],
  },
];
