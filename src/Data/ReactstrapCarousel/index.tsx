export const constReactstrapCarouselData = [
    {
        text: 'The',
        code: '.active'
    },
...
export const SliesOnlyDataList = [
  ...
  export const WithIndicatorList = [
    {
        text: 'Use the',
  ...
  export const DisableTouchSwipingsList = [
    {
