...
export const TotalBudgeChart : ApexOptions = {
      series: [{
        name: "Desktops",
...
fill: {
    ...
    gradient: {
        ...
        type: "vertical",
        shadeIntensity: 1,
        gradientToColors: ['#015DBE', '#fff5f7', '#015DBE'],
        inverseColors: true,
        opacityFrom: 0.4,
        opacityTo: 0,
        stops: [0, 100, 100, 100]
...
const generateMinuteWiseTimeSeries = (baseval: number, count: number, yrange: { min: number; max: number }): [number, number][] => {
  var i = 0;
...
export const OrderStatusCharts : ApexOptions = {
   chart: {
     height: 350,
     type: "line",
     stacked: true,
           ...
           chartCtx.updateOptions(
             {
               ...
               subtitle: {
                 text: Math.floor(getRandom() * Math.random()).toString(),
               },
             },
             false,
             false
...
export const MontlySaleChart : ApexOptions = {
    fill: {
      type: "gradient",
      gradient: {
        shade: "dark",
...
const generateData = (baseval: number, count: number, yrange: { min: number; max: number }): [number, number, number][] => {
 var i = 0;
...
export const UsersChart : ApexOptions = {
    chart: {
      toolbar: {
        show: false,
      },
