...
export const BorderedRadioDataa = [
  {
    id: "radio55",
    color: "success",
    text: "Roxo Theme ",
...
export const DefultSelectData = [
  { text : ' Use the tagify plugin for drag and sort options available.'}
]

export const inputsData = [
  { 
    type: 'dropdown',
    className: 'badge-light-primary text-dark', 
  ...
  { 
    type: 'dropdown',
    className: 'badge-light-secondary text-dark', 
    name: 'tags-select-value-mode', 
    placeholder: 'Please select' ,
    options: [
...
export const CurrentCartData = [
 ...
 export const SelectData = ["Technology","Culture","NGO","Environment","Life cycle"]
