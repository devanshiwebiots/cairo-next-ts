export const FlagIconData = [
  ...
  export const IcoIconData = [  
    { title: "Abstract", icons: ["angry-monster", "bathtub", "bird-wings", "bow", "brain-alt", "butterfly-alt", "castle", "circuit", "dart", "dice-alt", "disability-race", "diving-goggle", "fire-alt", "flame-torch", "flora", "flora-flower", "gift-box", "halloween-pumpkin", "hand-power", "hand-thunder", "king-crown", "king-monster", "love", "magician-hat", "native-american", "open-eye", "owl-look", "phoenix", "queen-crown", "robot-face", "sand-clock", "shield-alt", "ship-wheel", "skull-danger", "skull-face", "snail", "snow-alt", "snow-flake", "snowmobile", "space-shuttle", "star-shape", "swirl", "tattoo-wing", "throne", "touch", "tree-alt", "triangle", "unity-hand", "weed", "woman-bird"] },
