import { SaleChartData } from "@/Data/Widgets/chart";
        ...
        <Col lg="4" md={index == 2 ? "12" : "6"} className="box-col-4" key={index}>
          <Card className="o-hidden">
            <div className="chart-widget-top">
              ...
              <div id={data.id} className="flot-chart-placeholder">
                <ReactApexChart options={data.chart} series={data.chart.series} type={data.chart.chart?.type} height={200} width={499} />
              </div>
            </div>
          </Card>
        </Col>
