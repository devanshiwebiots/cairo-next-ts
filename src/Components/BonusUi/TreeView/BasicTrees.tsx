...
import { BasicTreeData, TreeViewList } from "@/Data/Uikits/TreeView";
...
export const CheckBoxIcon = ({ variant, ...rest }: BasicTreesProp) => {
  switch (variant) {
    ...
    case "some":
      return <FaMinusSquare {...rest} color="#7A70BA" />;
    default:
      return null;
  }
};
...
const BasicTrees = () => {
  ...
  return (
    <Card>
      <CommonCardHeader title={BasicTree} span={BasicTreeData} spanClass="mt-1 mb-0" headClass="pb-0" />
      <CardBody>
