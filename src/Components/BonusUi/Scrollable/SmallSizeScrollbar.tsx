...
const SmallSizeScrollbar = () => {
  return (
    <Col xl="6">
      <Card>
        <CommonCardHeader title={SmallSizeScrollbars} span={SmallSizeScroll} headClass="pb-0" spanClass="mt-1 mb-0" />
        <CardBody>
          <div className="scroll-bar-wrap">
            <ScrollBar className="scrollbar-margins large-margin scroll-demo pe-0" style={{ width: "100%", height: "300px" }}>
              ...
              <p>
                ...
                <RatioImage className="img-fluid pt-3" src={`${ImagePath}/banner/3.jpg`} alt="business" />
              </p>
              <p>
