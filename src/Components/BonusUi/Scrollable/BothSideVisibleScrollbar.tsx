...
const BothSideVisibleScrollbar = () => {
  return (
    <Col xl="6">
      <Card>
        <CommonCardHeader title={BothSideVisibleScrollbars} span={BothSideScrollData} spanClass='mt-1 mb-0' headClass="pb-0"/>
        <CardBody>
          <div className="scroll-bar-wrap">
            <ScrollBar className="scroll-demo horizontal-scroll" style={{width:"100%", height:"300px"}}>
              <div className="horz-scroll-content">
                <Row>
                  <Col sm="3">
                    <div className="visible-wrapper"><RatioImage src={`${ImagePath}/banner/2.jpg`} alt="office-work" /></div>
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><RatioImage src={`${ImagePath}/email/3.jpg`} alt="office" /></div>
                  </Col>
                  <Col sm="3">
                  ...
                  <Col sm="3">
                    ...
                    <div className="visible-wrapper"><RatioImage src={`${ImagePath}/banner/3.jpg`} alt="website" /></div>
