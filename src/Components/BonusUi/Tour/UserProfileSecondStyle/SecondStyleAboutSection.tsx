...
export const SecondStyleAboutSection = () => {
  ...
  return (
    <Fragment>
      ...
      <Row className="g-3 mt-2 pictures" id="aniimated-thumbnials-2">
        <Col sm="6">
          <Link href={Href}>
            <div className="tour-blog">
              <RatioImage className="img-fluid rounded" src={`${ImagePath}/other-images/mountain.jpg`} alt="mountain" />
            </div>
          </Link>
        </Col>
        <Col sm="6">
          <Link href={Href}>
            <div className="tour-blog">
              <RatioImage className="img-fluid rounded" src={`${ImagePath}/other-images/sea.jpg`} alt="sea" />
            </div>
          </Link>
        </Col>
      </Row>
