  ...
  return (
    <Col xxl="3" className="box-col-4e">
      <div className="md-sidebar mb-3">
        <Button color="primary" className="md-sidebar-toggle" href={Href} onClick={() => setOpenCalender(!openCalender)}>
          {CalendarFilter}
        </Button>
          ...
          <div id="external-events" className="calendar-default">
            ...
            <div className="external-events-list">
              {CalenderInitialData.events.map((event, index) => (
                <div className={`fc-event fc-h-event fc-daygrid-event fc-daygrid-block-event ${event.className}`} title={event.title} key={index}>
