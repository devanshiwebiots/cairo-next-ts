...
const CreateContact = () => {
  ...
  return (
   <Fragment>
   <button className="badge-light-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal" onClick={toggle}data-bs-target="#exampleModal"><User /> New Contacts</button>
