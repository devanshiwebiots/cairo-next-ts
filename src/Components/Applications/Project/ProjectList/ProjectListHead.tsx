      ...
      <Row>
        <Col md="6" className="p-0 d-flex">
          <Nav tabs className="border-tab" id="top-tab">
            <NavItem>
              <NavLink href={Href} className={activeTab === "1" ? "active" : ""} onClick={() => dispatch(setActiveTab("1"))}>
                <Target />
                {All}
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href={Href} className={activeTab === "2" ? "active" : ""} onClick={() => dispatch(setActiveTab("2"))}>
                <Info />
                {Doing}
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href={Href} className={activeTab === "3" ? "active" : ""} onClick={() => dispatch(setActiveTab("3"))}>
                <CheckCircle />
                {Done}
              </NavLink>
            </NavItem>
        ...
        <Col md="6" className="p-0">
          ...
          <Link href={`/project/new_project`} className="btn btn-primary">
            <PlusSquare />
            {CreateNewProject}
          </Link>
        </Col>
