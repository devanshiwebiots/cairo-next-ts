import { BasicInputGroupBasic, FlexNowrapCodeText, RecipientPlaceholder, ServerPlaceholder, UsernamePlaceholder, WithTextarea, Wrapping, WrappingParagraph, YourVanityUrl } from "@/Constant";
      ...
      <Row className="g-3">
        <Col md="12">
          <div className="card-wrapper border rounded-3 main-custom-form input-group-wrapper">
            <h6 className="sub-title">{BasicInputGroupBasic}</h6>
            <InputGroup>
