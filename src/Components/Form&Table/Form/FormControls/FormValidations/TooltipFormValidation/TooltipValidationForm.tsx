...
import { City, CityFeedback, FirstName, LastName, LookGood, MarkFirstNamePlaceholder, State, StateChoose, StateFeedback, SubmitButton, Username, UsernameFeedback, Zip, ZipFeedback, OttoLastNamePlaceholder } from "@/Constant";
...
export const TooltipValidationForm:React.FC<TooltipFormValidationProp>=({errors,submitErrors,setSubmitError})=> {
  return (
    <Form>
      <Row className="g-3 custom-input needs-validation">
        <Col md="4" className="position-relative">
          ...
          <div className="valid-tooltip">{LookGood}</div>
        </Col>
        <Col md="4" className="position-relative">
