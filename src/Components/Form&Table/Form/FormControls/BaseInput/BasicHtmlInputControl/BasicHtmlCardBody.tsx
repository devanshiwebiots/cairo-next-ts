    ...
    <CardBody className="custom-input">
      <Row>
        <Col>
          ...
          <CommonFormGroup inputType="datetime-local" label={BasicDateAndTime} colSm="9" defaultValue={FullDateAndTime} inputClass="digits" />
          ...
          <CommonFormGroup inputType="color" colSm="2" label={BasicColorPicker} labelClass="pt-0" inputClass="form-control-color" defaultValue="#015DBE" />
