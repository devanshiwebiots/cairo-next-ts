import { AgreeToTermsAndConditions, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourFirstName, FirstName, MofiEmail, Password } from '@/Constant';
