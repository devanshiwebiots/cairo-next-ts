import { Address, ContactNumber, Email, EnterMobileNumber, EnterYourFirstName, EnterYourLastName, FirstName, LastName, MofiEmail } from '@/Constant';
  ...
  return (
    <Fragment>
      ...
      <Col sm="6" className='mb-3'>
        ...
        <Input value={email} onChange={getUserData} name="email" type="email" placeholder={MofiEmail} />
      </Col>
      <Col sm="12" className='mb-3'>
        <Label check className='mb-1'>{Address}</Label>
