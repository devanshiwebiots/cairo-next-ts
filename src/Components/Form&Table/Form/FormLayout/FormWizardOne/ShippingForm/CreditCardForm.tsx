import { AboveInformationCorrect, CardHolder, CardHolderPlaceholder, CardNumberPlaceholder, CardNumberr, CVVNumber, Expiration, ExpiryPlaceholder, UploadDocumentation } from '@/Constant'
