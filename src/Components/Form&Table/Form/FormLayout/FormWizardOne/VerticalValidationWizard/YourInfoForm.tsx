...
import { AgreeToTermsAndConditions, ContactNumber, Email, EnterMobileNumber, EnterYourFirstName, EnterYourLastName, FirstName, LastName, CairoEmail, Next, State, Zip, ZipCode } from "@/Constant";
      ...
      <Row>
        ...
        <Col xxl="4" sm="6">
          <FormGroup>
            ...
            <Input type="email" placeholder={CairoEmail} name="email" value={email} onChange={getUserData} />
          </FormGroup>
        </Col>
        <Col xxl="5" sm="6">
          <FormGroup>
