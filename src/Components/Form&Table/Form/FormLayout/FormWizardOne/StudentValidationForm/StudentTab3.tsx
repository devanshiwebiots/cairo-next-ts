import { Github, GitHubPlaceholder, SocialLinks, Submit, Twitter, TwitterPlaceholder } from '@/Constant'
  ...
  return (
   <Fragment>
     ...
     <Row className='g-3'>
        ...
        <Col xs='12'>
            <InputGroup>
             <Input name='studentFile' type='file' onChange={getUserData}/>
        ...
        <Col xs='12'>
            ...
            <Input type='textarea' name='positionQuestion' onChange={getUserData} id='questionsTextarea' row={2} defaultValue=''/>
        </Col>
     </Row>
   </Fragment>
  )
