                ...
                <Form className="theme-form" onSubmit={(e)=>e.preventDefault()}>
                  ...
                  <FormGroup>
                    ...
                    <div className="position-relative">
                      <Input className="password-hide" type={show ? "text" : "password"} required placeholder="*********" autoComplete="off"/>
                  ...
                  <FormGroup>
                    ...
                    <Input type="password" className="password-hide" required placeholder="*********" autoComplete="off"/>
                  </FormGroup>
