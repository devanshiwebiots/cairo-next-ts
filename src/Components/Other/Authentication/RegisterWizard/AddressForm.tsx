      ...
      <div className="login-main">
        <div className="theme-form">
          ...
          <div className="form-group mb-3">
            ...
            <Input onChange={getUserData} value={password} name="password" id="exampleInputPassword1" type="password" placeholder={PasswordWizardPlaceholder} autoComplete="off"/>
          </div>
          <FormGroup className="mb-3">
            <Label htmlFor="exampleInputPassword1" check>{ConfirmPasswordWizard}</Label>
            <Input onChange={getUserData} value={confirmPassword} name="confirmPassword" id="exampleInputcPassword1" type="password" placeholder={ConfirmPasswordWizardPlaceholder} autoComplete="off"/>
          </FormGroup>
        </div>
      </div>
    </div>
