import { CreateAccount, DontHaveAccount, EmailAddressLogIn, FacebookIcon, ForgotPassword, ImagePath, LinkedInIcon, OrSignInWith, Password, RememberPassword, Signin, SignInToAccount, TwitterIcon } from "@/Constant/index";
import { validationSchema } from "@/Data/pageAuth";
            ...
            <Form className="theme-form">
              ...
              <FormGroup className="mb-0">
                ...
                <div className="position-relative">
                  <Field className="form-control mb-0" type={show ? "text" : "password"} name="password" required placeholder="*********" autoComplete="off"/>
              ...
              <FormGroup className="form-group mb-0 pb-0">
                <div className="checkbox p-0">
                  <Input id="checkbox1" type="checkbox" className="mb-0" />
