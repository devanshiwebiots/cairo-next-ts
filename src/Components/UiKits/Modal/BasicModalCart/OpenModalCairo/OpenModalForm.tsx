import { AcceptPolicy, AgreeToTermsAndConditions, EmailAddress, EnterYourFirstName, EnterYourLastName, FirstName, LastName, MofiEmail, SignUp } from '@/Constant';
               ...
               <Row>
                 ...
                 <Col md="12">
                   <FormGroup check>
                     ...
                     <Label check className="text-success">{AcceptPolicy}</Label>
                   </FormGroup>
