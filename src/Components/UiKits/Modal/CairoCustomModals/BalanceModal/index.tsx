    ...
    <Col xl="4" md="12" className="custom-alert text-center">
      <div className="card-wrapper border rounded-3 h-100">
        <div className="cairo-demo-img">
          <CommonCairoModalTitle heading="Modal 3 -" subHeading="Balance Modal" text="Example of Cairo dashboard balance card." />
          <div className="overflow-hidden balance-modal">
            <Button color="primary" className="mx-auto mt-3" onClick={modalThirdTogggle}>
              {ClickHere}
            </Button>
          </div>
