...
const LargeModal = () => {
  ...
  return (
    <Fragment>
      ...
      <CommonModal size='lg' toggle={largeScreenToggle} isOpen={largeScreen} sizeTitle='Large modal' modalBodyClassName='dark-modal'>
        <div className='large-modal-header mb-2'><ChevronsRight /><h5>{StartWithYourGoals}</h5></div>
