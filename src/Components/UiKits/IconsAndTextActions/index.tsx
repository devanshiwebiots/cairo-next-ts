...
import { IconsAndTextActionsSpan } from "@/Data/Uikits/Alerts";
import { IconandtextAction } from "@/Constant";
...
const AlertsWithIconsandTextActions = () => {
  ...
  return (
    <Col sm="12" xl="6">
      <Card>
        <CommonCardHeader title={IconandtextAction} span={IconsAndTextActionsSpan} spanClass='mt-1 mb-0' headClass="pb-0"/>
        <CardBody>
