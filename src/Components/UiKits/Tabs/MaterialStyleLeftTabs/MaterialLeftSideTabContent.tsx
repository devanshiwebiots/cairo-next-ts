      ...
      <TabContent activeTab={basicTab}>
        ...
        <TabPane tabId="2">
         ...
         <div className="flex-space flex-wrap align-items-center">
          <Image className="tab-img" src={`${ImagePath}/ecommerce/08.jpg`} alt="profile" width={92} height={100} unoptimized/>
            ...
            <div className="main-inbox"> 
              <div className="header-inbox justify-content-start gap-2">
                <div className="header-left-inbox">
                  <div className="inbox-img"><Image src={`${ImagePath}/ecommerce/07.jpg`} alt="profile" width={50} height={50} unoptimized/></div>
                </div>
